...
# Parsing + Configuration Script – Skid - Rev. A

This **Parsing + Configuration** script is designed for the **Skid** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Skid Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Skid** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
