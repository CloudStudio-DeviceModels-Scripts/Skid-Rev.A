...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  var e = endpoints.addEndpoint("1", "Nivel Skid", endpointType.genericSensor);
  e.variableTypeId = 1073
  var e = endpoints.addEndpoint("2", "Temperature", endpointType.temperatureSensor);
  var e = endpoints.addEndpoint("3", "Battery", endpointType.genericSensor);
  e.variableTypeId = 1074
}
